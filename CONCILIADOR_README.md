...
\[!\[Retail](https://img.shields.io/badge/Industria-Retail\_/\_Logística-orange?style=flat-square)]()
...
```bash
python conciliar\_inventarios.py
```
...
─── FUENTE 1: Inventario General (almacén/físico) ───
  Ruta del archivo (.xlsx, .xlsm, .csv): C:\\datos\\inventario\_general.xlsx
...
```python
GEN\_PATH   = r"C:\\ruta\\inventario\_general.xlsx"
CLI\_PATH   = r"C:\\ruta\\inventario\_clientes.xlsx"
GEN\_SHEET  = "INV FISICO"
CLI\_SHEET  = "INV CLIENTES"
FORCED\_KEY\_COL       = "UPC"
FORCED\_TOTAL\_COL\_GEN = "TOTAL FISICO"
FORCED\_TOTAL\_COL\_CLI = "TOTAL FISICO"
OUTPUT\_PATH = r"C:\\ruta\\salida\\conciliacion\_resultado.xlsx"
```
...
[!\[LinkedIn](www.linkedin.com/in/angel-jimenez-28696b255)](https://www.linkedin.com/in/TU_PERFIL)
